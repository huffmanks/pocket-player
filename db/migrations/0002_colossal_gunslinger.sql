...
CREATE TABLE `__new_playlists` (
	...
	`created_at` text DEFAULT '2025-04-20T00:41:58.240Z' NOT NULL,
	`updated_at` text DEFAULT '2025-04-20T00:41:58.240Z' NOT NULL
);
...
CREATE INDEX `videos_thumb_uri_idx` ON `videos` (`thumbUri`);--> statement-breakpoint
